      ...
      <div className={`relative bg-gray-800 text-white shadow-lg rounded-lg p-10 max-w-md w-full
       ...
       ${formVisible ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-10'} transform transition-all duration-500
        ease-out`}>
          ...
          hover:from-cyan-600 hover:to-blue-600 transition-all duration-300 focus:ring-cyan-300
...
{/*DIVIDER*/}
           <div className=' mt-8 flex items-centre justify-between'>
...
{/* GOOGLE BUTTON*/}            
           ...
           <p className='text-center text-gray-400 text-sm mt-6' >
            Don'th have an account? <a href='#' className='text-cyan-400 hover:underline'> Signup</a>
           </p>
        </div>
       </div>
       )
